  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength') && !VALIDATORS.minlength(value, field.getAttribute('minlength'))) {
        ...
        showError(field, field.dataset.errorMinlength || 'Please enter at least ' + min + ' characters.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c40847f6-29e2-4adf-b899-237e9967b16e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c40847f6-29e2-4adf-b899-237e9967b16e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ff5e3ec8-5b05-4fa9-b05d-3c907abae5b6';
